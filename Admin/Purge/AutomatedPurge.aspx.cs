...
using Amazon; // Make sure this is included for RegionEndpoint
    ...
    public partial class AutomatedPurge : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataFunctions.RunStatement("Delete From Characters Where UserID not in (Select UserID from Users) Or OwnerUserID In (Select UserID From Users Where Password like 'UserBanned%');" +
                ...
                "Delete From Articles Where OwnerUserID not in (Select UserID from Users) Or OwnerUserID In (Select UserID From Users Where UserID In (Select UserID From Users Where Password like 'UserBanned%'));" + // Corrected line
                "Delete From Thread_Users Where UserID not in (Select UserID from Users) Or UserID In (Select UserID From Users Where Password like 'UserBanned%');"); // Corrected line
            ...
            // Fetch AWS credentials from Web.config
            ...
            do
            {
                ...
                AmazonS3Client AWSClient = new AmazonS3Client(awsAccessKey, awsSecretKey, Amazon.RegionEndpoint.GetBySystemName("us-east-2")); // Changed to GetBySystemName and added credentials
                listResponse = AWSClient.ListObjectsV2(listRequest); // Use the initialized AWSClient
