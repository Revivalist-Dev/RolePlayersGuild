...
<%-- Changed to TypeName for MasterType to explicitly define the master page class --%>
<%@ MasterType TypeName="RolePlayersGuild.templates._2_Col_With_Authentication" %>
